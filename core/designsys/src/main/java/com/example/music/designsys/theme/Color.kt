...
val lightDefaultSetRsc = lightColorScheme(
    ...
    surfaceTint = Color(R.color.primary_light),
...
val darkDefaultSetRsc = darkColorScheme(
    ...
    surfaceTint = Color(R.color.primary_dark),
...
val blueLightSet = lightColorScheme(
    ...
    surfaceTint = Color(R.color.primary_blue_light),
...
val blueDarkSet = darkColorScheme(
    ...
    surfaceTint = Color(R.color.primary_blue_dark),
