...
object Actions {
    ...
    val AddToPlaylist: ActionItem = ActionItem("Add to Playlist", Icons.AutoMirrored.Filled.PlaylistAdd, R.string.icon_add_to_playlist) // TODO: is for individual song, for multiple songs if selection works, for album, for artist, for composer, for genre, for playlist
    val AddToQueue: ActionItem = ActionItem("Add to Queue", Icons.Filled.Queue, R.string.icon_add_to_queue) // TODO: is for individual song, for multiple songs if selection works, for album, for artist, for composer, for genre, for playlist

    val GoToArtist: ActionItem = ActionItem("Go to Artist", Icons.Filled.Person, R.string.icon_artist) // TODO: navigateToArtistDetails(transform artistName to artist.Id)
    val GoToAlbumArtist: ActionItem = ActionItem("Go to Album Artist", Icons.Filled.Person, R.string.icon_artist) // TODO: navigateToArtistDetails(transform artistName to artist.Id)
    val GoToAlbum: ActionItem = ActionItem("Go to Album", Icons.Filled.Album, R.string.icon_album) // TODO: navigateToAlbumDetails(transform albumTitle to album.Id)
