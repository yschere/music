        ...
        NavHost(
            ...
            composable(Screen.Library.route) { backStackEntry ->
                LibraryScreen(
                    ...
                    //navigateToGenreDetails = { genre -> appState.navigateToGenreDetails(genre.id, backStackEntry) },
                    //navigateToComposerDetails = { composer -> appState.navigateToComposerDetails(composer.id, backStackEntry) },
                    navigateToPlayer =  { song ->
                        appState.navigateToPlayer(song.id, backStackEntry)
                    },
                    //TODO: PlayerSong support
